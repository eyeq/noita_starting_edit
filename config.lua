    ...
    -- starting_loadouts --
    {
        ...
        guns = {
            ...
            },
            {
                ...
                mana_max = {120, 150},
                action_permanents = {"SUMMON_ROCK"},
                special_action_permanents = {"SUMMON_EGG"},
                special_action_permanents_chances = 0,
            },
        },
        items = {
            {
        ...
        guns = {
            {
                ...
                special_action_permanents = {"FIRE_TRAIL", "OIL_TRAIL", "BURN_TRAIL"},
                action_count = 1,
                modifier_count = {1, 2},
                special_action_permanents_chances = 40,
            },
            {
                sprite = "data/entities/items/wands/level_01/wand_002.xml",
                name = {"fire_wand"},
                ...
                modifiers = {"TORCH"},
                special_action_permanents = {"OIL_TRAIL"},
                modifier_count = {0, 1},
                special_action_permanents_chances = 2,
            },
        },
        items = {
            {
    ...
    },
    {
        ...
        guns = {
            ...
            },
            {
                ...
                modifiers = {"SPEED"},
                action_permanents = {"HITFX_EXPLOSION_SLIME"},
                action_count = 1,
                modifier_count = 1,
            },
            {
